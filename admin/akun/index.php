                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <a class="btn btn-primary" href="tambah-akun.php">Tambah Data Akun</a><br><br>
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!-- baris aksi -->
                                            <td>
                                                <a class="btn btn-primary" href="ubah-akun.php?username=<?= $row["username"]?>">Ubah</a>
                                                <a class="btn btn-primary" href="hapus-akun.php?username=<?= $row["username"];?>" onclick=" return confirm('Apakah Anda Ingin Menghapusnya?');">Hapus</a>
