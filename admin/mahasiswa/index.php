...
$mahasiswa = query("SELECT * FROM tabel_biodata_mahasiswa");
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="../dosen/index.php">Data Dosen</a>                                
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <a class="btn btn-primary" href="tambah-mahasiswa.php">Tambah Data Mahasiswa</a><br><br>
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!-- baris aksi -->
                                            <td>
                                                <a class="btn btn-primary" href="ubah-mahasiswa.php?nim=<?= $row["nim"]?>">Ubah</a>
                                                <a class="btn btn-primary" href="hapus-mahasiswa.php?nim=<?= $row["nim"]; ?>" onclick=" return confirm('Apakah Anda Ingin Menghapusnya?');">Hapus</a>
