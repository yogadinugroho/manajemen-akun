                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Ubah Data Mahasiswa</h3></div>
                                    <div class="card-body">
                                        ...
                                        <!-- form nama -->
                                         ...
                                         <!--form nim  -->
                                            <div class="form-floating mb-3">
                                                        <input class="form-control" id="nim" name="nim" value="<?= $mhs["nim"] ?>" type="text" placeholder="Nim" />
                                        ...
                                        <!-- form gambar -->
                                            <div class="form-floating mb-3 mb-md-0">                                                
                                                ...
                                                <img src="../admin/mahasiswa/img/<?= $mhs['gambar_profil']; ?>" width=100px"><br>                                                        
                                            </div>
                                        <!-- form submit -->
                                            <div class="mt-4 mb-0">
